"""Script to generate themes and sectors market share trend chart."""
...
def create_themes_sectors_chart(datasets, output_path):
    """Create line chart showing themes and sectors market share trends.
    ...
    ax.set_title(
        'Themes & Sectors Market Share Trends (2004-2025)',
...
def main():
    ...
    output_path = output_dir / 'themes_sectors_trends.png'
    ...
    print(f"Loaded {len(datasets)} themes/sectors datasets:")
    for name in datasets:
        years, shares = datasets[name]
        print(f"  - {name}: {len(years)} data points")
    
    # Generate chart
    print("\nGenerating themes & sectors chart...")
    create_themes_sectors_chart(datasets, str(output_path))
    print("Done!")
